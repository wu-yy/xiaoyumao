...
//		curl_setopt($ch,CURLOPT_SSL_VERIFYHOST,2);//严格校验
		...
		if($useCert == true){
			...
			curl_setopt($ch,CURLOPT_SSLCERT, getcwd().'/application/libraries/wx_pay/cert/apiclient_cert.pem');

			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY, getcwd().'/application/libraries/wx_pay/cert/apiclient_key.pem');
	 ...
	 * @return 成功时返回，其他抛异常
	 */	
	public static function sendHongBao( $xml, $url)
	{
		$startTimeStamp = self::getMillisecond();//请求开始时间
